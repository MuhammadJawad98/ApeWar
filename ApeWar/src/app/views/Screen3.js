    ...
    <View style={styles.container}>
      ...
      <View style={styles.midContainer}>
        <View style={styles.trees}>
          <Image source={require('../assets/header1black.png')} />
          <Image source={require('../assets/yourApesAre.png')} />
          <Image source={require('../assets/leftTree.png')} />
        </View>
      </View>
      <View style={{width: '100%', height: 50}}>
        <Image source={require('../assets/grassField.png')} />
      </View>
      ...
      <View style={{paddingTop: 20, paddingLeft: 10}}>
        <Image source={require('../assets/xefcText.png')} />
      </View>
      <View
        style={{
          flexDirection: 'row',
